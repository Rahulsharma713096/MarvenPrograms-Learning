...
public class ConnectionFactory {
	...
	static {
		...
		try {
			...
			properites.load(new FileInputStream("C:\\Users\\HP\\eclipse-workspace\\Maven\\JDBCAPP\\src\\main\\java\\resources\\connection.properties"));
